...
if not os.path.isfile(".env"):
    print(
        "Le fichier .env définissant les informations de connexion aux bases de données est manquant."
    )
    exit(1)
...
print()
print(
    "L'énoncé et le repository original du TP est disponible sur: https://github.com/lvovan/CS-IMC-TPBDD"
)
print()
